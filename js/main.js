...
function score(total){
    ...
    if(result_num <= 59){
        ...
        resultDesc.innerHTML = "자신의 문제를 분명히 할 수 있고, 자신의 문제를 잘 다루며, 자신의 감정을 행동으로 표현하는 능력이 있다. 그러나 때로 좋고 싫음이 너무 분명하거나 기복이 심해 친한 동료와 분명한 적을 가진 경우가 많다. 이따금 자신의 감정이 슬픈 건지 기쁜 건지, 화난 건지 두려운 건지 잘 모를 때가 있다. 그러나 이런 사람들이 자기 감정을 분명히 표현하고, 실패를 두려워하지 않고, 매사를 흑백논리로 보지 않으려 하고, 타인의 입장에 서서 생각하는 습관을 기른다면 우수한 EQ수준으로 발전할 수 있다. EQ, 자신의 노력에 따라 언제든 계발될 수 있다.";
